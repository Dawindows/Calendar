...
/*!*******************!*\
  !*** ./script.js ***!
  \*******************/
eval("\n\n__webpack_require__(/*! ./authorization/authorization.scss */ \"./authorization/authorization.scss\");\n\nvar _authorization2 = __webpack_require__(/*! ./authorization/authorization */ \"./authorization/authorization.js\");\n\nvar _calendar = __webpack_require__(/*! ./calendar/calendar */ \"./calendar/calendar.js\");\n\nconst memberElement = JSON.parse(localStorage.getItem('member')) || [];\n\nif (memberElement.name) {\n  const calendar = new _calendar.Calendar(document.body, memberElement._isAdmin, memberElement.name);\n  calendar.render();\n} else {\n  const authorization = new _authorization2.Authorization(document.body);\n  authorization.render();\n}\n\n//# sourceURL=webpack:///./script.js?");
})();
